...
class RootView extends React.Component {
    constructor(props) {
        ...
        // focusable elements.
        this._focusManager = new FocusManager_1.default();
    ...
    render() {
        ...
        if (this.props.activePopupOptions) {
            ...
            optionalPopup = (React.createElement("div", { style: popupContainerStyle, ref: 'popupContainer', onMouseEnter: e => this._onMouseEnter(e), onMouseLeave: e => this._onMouseLeave(e) }, this.props.activePopupOptions.renderPopup(this.state.anchorPosition, this.state.anchorOffset, this.state.constrainedPopupWidth, this.state.constrainedPopupHeight)));
        }
        let optionalModal = null;
        if (this.props.modal) {
    ...
    _determineIfClickOnElement(elementReference, eventSource) {
        const element = ReactDOM.findDOMNode(elementReference);
    ...
    _recalcPosition() {
        ...
        if (this.state.isMeasuringPopup) {
            ...
            let popup = ReactDOM.findDOMNode(this.refs['popupContainer']);
            if (!popup) {
                return;
            }
        ...
        let anchor = ReactDOM.findDOMNode(this.props.activePopupOptions.getAnchor());
