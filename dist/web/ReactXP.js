...
const AnimatedImpl = require("./Animated");
...
const International_1 = require("./International");
...
const Popup_1 = require("../web/Popup");
...
App_1.default.activationStateChangedEvent.subscribe(newState => {
