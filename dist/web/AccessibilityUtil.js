...
class AccessibilityUtil extends AccessibilityUtil_1.AccessibilityUtil {
    ...
    accessibilityTraitToString(traits, defaultTrait) {
        // Combine & remove duplicate traits.
        let combinedTraits = defaultTrait ? [defaultTrait] : [];
        if (traits) {
        ...
        return combinedTraits.length > 0 ?
            roleMap[_.max(_.filter(combinedTraits, t => roleMap.hasOwnProperty(t)))]
            : undefined;
    }
    accessibilityTraitToAriaSelected(traits) {
